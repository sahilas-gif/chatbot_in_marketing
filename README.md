...
- **☁️ Infrastructure as Code (IaC):** Contains a declarative `render.yaml` for automated, one-click CI/CD deployments using enterprise-grade **Gunicorn** WSGI process managers instead of basic dev servers.
